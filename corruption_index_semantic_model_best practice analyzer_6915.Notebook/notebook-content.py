...
dataset = "corruption_index_semantic_model" # Enter the name or ID of the semantic model
workspace = "Presidential-Delivery-Unit" # Enter the workspace name or ID in which the semantic model exists
