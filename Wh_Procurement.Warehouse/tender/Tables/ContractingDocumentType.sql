...
ALTER TABLE [tender].[ContractingDocumentType] ADD CONSTRAINT FK_ContractingDocumentType_DocumentTypeId FOREIGN KEY ([DocumentTypeId]) REFERENCES [tender].[DocumentType]([DocumentTypeId]);